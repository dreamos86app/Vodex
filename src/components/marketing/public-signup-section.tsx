...
export function PublicSignupSection() {
  ...
  return (
    ...
    >
      <motion.div className="relative overflow-hidden rounded-[1.75rem] border border-accent/20 bg-gradient-to-br from-accent/[0.08] via-background to-sky-500/[0.06] p-6 text-center shadow-[0_24px_64px_-28px_rgba(30,107,255,0.3)] ring-1 ring-border/80 sm:p-10">
        <div
          aria-hidden
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            <Button asChild size="lg" className="h-11 rounded-full px-8 text-[14px]">
              <Link href="/auth/signup">Create your account</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="h-11 rounded-full px-8 text-[14px]">
          ...
          <div className="mt-4 flex flex-col gap-2.5 sm:flex-row sm:justify-center">
            <Button
              type="button"
              variant="outline"
              className={cn("h-11 flex-1 rounded-full sm:max-w-[220px]", oauthLoading === "google" && "opacity-70")}
            ...
            <Button
              type="button"
              variant="outline"
              className={cn("h-11 flex-1 rounded-full sm:max-w-[220px]", oauthLoading === "github" && "opacity-70")}
              disabled={oauthLoading !== null}
