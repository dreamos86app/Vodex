...
export const CREATION_MODELS: CreationModel[] = [
  ...
  // Google — Gemini 2.5 Pro
  {
    ...
    flagship: true,
    ratings: { intelligence: 4.8, reasoning: 4.7, frontend: 4.5, backend: 4.4, speed: 3.1, cost: 2.8, orchestration: 4.3 },
    multimodal: true,
    contextK: 1000,
    credits: 5,
  ...
  // Google — Gemini 3.1 Pro (default UI builder — routes to live Gemini Pro API)
  {
    id: "gemini-3-1-pro",
    name: "Gemini 3.1 Pro",
    provider: "google",
    tagline: "Best UI quality per credit — premium screens, components, and polish",
    flagship: true,
    ratings: { intelligence: 4.7, reasoning: 4.5, frontend: 4.9, backend: 4.3, speed: 3.5, cost: 3.6, orchestration: 4.4 },
    multimodal: true,
    contextK: 2000,
    credits: 4,
    specialization: "frontend",
    orchestrationRole: "UI lead — rich layouts, design systems, and production-grade React pages",
    idealFor: ["Full app UI generation", "Dashboards & data UI", "Design-to-code", "Polished component libraries"],
    weaknesses: ["Not ideal for heavy backend-only logic"],
    accent: "#4285f4",
  },
